...
function AdminStatCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] bg-white/92 p-5 shadow-[0_18px_55px_rgba(15,23,42,0.08)] ring-1 ring-white/80 backdrop-blur sm:p-6">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-slate-950 via-emerald-500 to-sky-400" />
      <div
        className={[
